...
-   ***Total \# of discussion messages posted & \# of assessments submitted***
...
-   ***The contribution of discussion messages was the single most significant predictive variable for the course***
...
-   **I am noticing that many of the students who spent a lot of time in the online class also enrolled in the class because it was not available locally for them.**
-   **A few of the students chose to take the course because of either a learning preference or because there was a scheduling conflict. (Is there another course that they wanted to take but it didn't align with their required courses?)**
-   **Many of the students who took the class due to "scheduling conflicts" were enrolled in "AnPhA" - was there only one class available of the other type?**
...
-   **The survey CSV seems to be incomplete? There are some columns with no information added such as the column titled "post_int" and "post_uv". It is unclear what these columns mean and what information they are trying to share.**
...
-   **Yes, because it is unclear what each column is supposed to represent, and some columns have more than one type of information under them.**
